...
namespace Servicios.Multiidioma
{
    ...
    public static class Traductor
    {
            ...
            Construir(new Dictionary<string, string>
        {
            ...
            { "err.seg.sesion_no_iniciada",          "La sesión no está iniciada. Iniciá sesión primero." },
            { "err.seg.sesion_ya_iniciada",          "Ya hay una sesión iniciada. Cerrá la sesión actual antes de iniciar otra." },
            ...
            Construir(new Dictionary<string, string>
        {
            ...
            { "err.seg.sesion_no_iniciada",          "No session is active. Please log in first." },
            { "err.seg.sesion_ya_iniciada",          "A session is already active. Log out before starting a new one." },
            ...
            Construir(new Dictionary<string, string>
        {
            ...
            { "err.seg.sesion_no_iniciada",          "Сессия не активна. Сначала войдите в систему." },
            { "err.seg.sesion_ya_iniciada",          "Сессия уже активна. Выйдите перед началом новой." },
            ...
            Construir(new Dictionary<string, string>
        {
            ...
            { "err.seg.sesion_no_iniciada",          "A sessão não está iniciada. Faça login primeiro." },
            { "err.seg.sesion_ya_iniciada",          "Já existe uma sessão ativa. Encerre a sessão atual antes de iniciar outra." },
