...
namespace GUI
{
    ...
    public partial class PrendaForm : Form
    {
        ...
        {
            int lx = 16, cx = 16, cw = 340, top = 16, gap = 52;

            // Nombre
            this.Controls.Add(new Label { Text = "Nombre *", Left = lx, Top = top, Width = cw });
            txtNombre = new TextBox { Left = cx, Top = top + 18, Width = cw };
            ...
            {
                Left = cx, Top = top + 18, Width = cw, Height = 54,
            ...
            {
                Left = cx, Top = top + 18, Width = 160,
                DropDownStyle = ComboBoxStyle.DropDownList
            };
            cmbTalle.Items.AddRange(new object[]
                { "XS", "S", "M", "L", "XL", "XXL", "34", "36", "38", "40", "42", "44", "46", "Único" });
            cmbTalle.SelectedIndex = 2; // M por defecto
            this.Controls.Add(cmbTalle);

            // Color
            this.Controls.Add(new Label { Text = "Color", Left = cx + 176, Top = top, Width = 150 });
            txtColor = new TextBox { Left = cx + 176, Top = top + 18, Width = 164 };
            ...
            {
                Left = cx, Top = top + 18, Width = cw,
                DropDownStyle = ComboBoxStyle.DropDownList
            };
            cmbCategoria.Items.AddRange(new object[]
            {
                "Vestido", "Falda", "Pantalón", "Camisa", "Blusa",
                "Saco / Blazer", "Abrigo", "Enterito / Jumpsuit",
            ...
            {
                Left = lx, Top = top, Width = cw, Height = 32,
            ...
            btnGuardar = new Button
            {
                ...
                Left = cx, Top = top, Width = 170, Height = 34,
            ...
            {
                Text = "Cancelar",
                Left = cx + 186, Top = top, Width = 100, Height = 34,
                FlatStyle = FlatStyle.Flat
            };
            ...
            this.ClientSize = new Size(376, top + 56);
        }
